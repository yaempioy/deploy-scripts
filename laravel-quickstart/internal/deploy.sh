...
SRC_MASTER_URL="http://13.229.122.172:8080"

#SERVER
SERVERS="ubuntu@52.221.232.220" # If deploys to more then one server can use "server-1-ip, server-2-ip"
SERVER_DOCKER_PATH="/var/dockers/$SITE_NAME"
SERVER_SOURCE_PATH="/var/www/$SITE_NAME"

#GITS
GITREPO_URL="https://$GIT_USER:$GIT_PASS@github.com/yaempioy"
